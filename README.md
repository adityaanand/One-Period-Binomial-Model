...
0 < d < 1 + r < u
Proof. If 1 + r ≤ d, the bond is dominated by the stock in all states, creating arbitrage by
shorting the bond and buying the stock. Conversely, if u ≤ 1+r, the stock is dominated. When
d < 1 + r < u, the law of one price holds and replication is possible.
